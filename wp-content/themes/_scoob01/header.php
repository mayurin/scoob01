...
$(function() {
	...
	var ajaxurl = '/scoob/wp-admin/admin-ajax.php';
	jQuery.ajax({
		type: 'POST',
		url: ajaxurl,
		data: {
...
<li><a href="https://twitter.com/share" class="twitter-share-button" data-url="http://scoob.info" data-text="webデザイナーのためのデザイン&テクニカルの情報発信サイト | Scoob" data-via="ScoobInfo" data-lang="ja" data-related="ScoobInfo" data-hashtags="ScoobInfo">ツイート</a><li>
